...
export type AccountProps = {
  children: ReactNode
  /**
   * THE ASIDE UNDER A CONTROL, rather than the account beside it.
   *
   * Two claims, not two sizes. The plain paragraph says what this control is and why it exists, and
   * a reader who does not know that cannot use the page. The quiet one says when a change takes
   * effect and what it does not do, which is a thing to look up rather than a thing to read, and
   * setting it at reading size makes every card twice as tall for a sentence nobody re-reads.
   */
  quiet?: boolean
}
 ...
 */
const ACCOUNT: Style = { margin: '0 0 12px', fontSize: '13px', lineHeight: 1.6, maxWidth: '72ch' }
